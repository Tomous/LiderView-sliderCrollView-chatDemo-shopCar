...
@interface DCSecondViewController ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
{
    FMDatabase *db;
}
...
-(void)setUpUI
{
    ...
    UITextField *receiveTextField = [[UITextField alloc]initWithFrame:CGRectMake(CGRectGetMaxX(self.sendTextField.frame) + Margin, CGRectGetMaxY(self.tableView.frame), self.sendTextField.width, 40)];
